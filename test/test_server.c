...
// Handling client request no credential test 
void test_handle_request_auth_fail(void) {
    HANDLE serverThread;
    SOCKET clientSocket;
...
// Handling client request correct credential test 
void test_handle_request_auth_pass(void) {
    HANDLE serverThread;
    SOCKET clientSocket;
    struct sockaddr_in server_addr;
    char response[1024] = {0};
...
void run_tests(void){
    ...
    RUN_TEST(test_handle_request_auth_fail);
    RUN_TEST(test_handle_request_auth_pass);
